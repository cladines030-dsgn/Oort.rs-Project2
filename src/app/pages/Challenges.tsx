...
export function Challenges() {
  ...
  const dropdownContent = {
    "What is Oort.rs?": "Oort.rs is a programming game where you control spaceships by writing JavaScript. Command everything from tiny missiles to massive cruisers. Your code runs in real-time simulations at 60 frames per second, managing engines, weapons, radar, and communications systems.",
    "How do I start?": "Begin your journey in the Tutorial to master basic ship control and combat tactics. Progress through Challenges to test your skills in specialized scenarios like Defense, Obstacle Course, and Shooting Carnival. When ready, face real opponents in Multi-Play mode.",
    "Your first mission": "Your first tutorial mission teaches fundamental ship control. Learn to activate engines, rotate your ship, and fire weapons. Master the radar system to detect enemies and coordinate fleet movements. Each lesson builds your skills for more complex battles."
  };
            ...
            <PageCard 
              ...
              icon={
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                  ...
                  <path d="M14 18L24 28L34 18" stroke="currentColor" strokeWidth="2" strokeDasharray="4 4" />
                  <circle cx="24" cy="32" r="4" stroke="currentColor" strokeWidth="2" />
                </svg>
              }
            >
              <p className="text-[#A8D8FF]">
                "Learn to fly. Learn to fight."
              </p>
            </PageCard>

            {/* Challenges Card - Expanded with buttons */}
            <motion.div 
              className="bg-card border border-primary p-8 h-full relative overflow-hidden"
              style={{
            ...
            >
              <div className="mb-4 text-primary">
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                  ...
                  <path d="M12 24L8 24M40 24L36 24M24 12L24 8M24 40L24 36" stroke="currentColor" strokeWidth="2" />
                </svg>
              </div>
              
              <h3 className="mb-4 uppercase tracking-wider text-white header-font">
                Challenges
              </h3>
            ...
            <PageCard 
              ...
              icon={
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                  ...
                  <path d="M18 18L30 30" stroke="currentColor" strokeWidth="2" strokeDasharray="2 2" />
                  <circle cx="24" cy="24" r="2" fill="currentColor" />
                </svg>
              }
            >
              <p className="text-[#A8D8FF]">
                "Code against real opponents."
              </p>
            </PageCard>
          </div>
